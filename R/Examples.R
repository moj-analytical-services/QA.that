...
## George Papadopoulos
##
## Examples running the QA.that package
##
######################################################################
...
use_QA(QA_file_name =  "A_B_match.R")


output44 = check_that(check_desc = "numeric matching test 1", {
  test_is_equal(descr = "test description text", 11,11)
...
# file_info_list = use_QA( QA_dir = file.path( "place_custom_root_directory_here","test_folder"), QA_file_name = "QA_that_A_B_match.R")

file_info_list = use_QA( QA_dir = file.path( getwd(),"test_folder"), QA_file_name = "A_B_match.R")
